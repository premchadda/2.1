...
*Source: `docs/development/Admin Panel doc.txt`*
...
router.post('/questions/bulk', adminLimiter, validateCsrfToken, async (req, res) => {
  try {
...
router.post('/tests/bulk', adminLimiter, validateCsrfToken, async (req, res) => {
  try {
