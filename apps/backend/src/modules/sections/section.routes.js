...
// Standalone mount (app-port5001.js: /api/sections, outside the canonical
// /api/admin chain which already applies CSRF + permissions). Mirror the
// canonical order: origin -> apiKey -> protect -> admin -> CSRF ->
// permissions -> audit. Do NOT change protect()/admin() signatures.
const adminAuth = [
  restrictAdminOrigin,
  validateAdminApiKey,
  protect,
