...
const questionBuilderService = {
  ...
  async create(data) {
    ...
    const questionData = {
      ...
      marks: data.marks || 1,
      negativeMarks: data.negativeMarks ?? data.negative_marks ?? 0.5,
        ...
        try {
          ...
          const result = await client.query(
            ...
            [
              ...
              question.marks || 1,
              question.negativeMarks ?? question.negative_marks ?? 0.5,
    ...
    try {
      ...
      await client.query(
        ...
        [
          ...
          questionData.negativeMarks ?? questionData.negative_marks ?? 0.5,
