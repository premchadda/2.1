 ...
 *
 * Also handles specific field aliasing for legacy fields (subcategory/subCategory,
 * seriesId/series_id, etc.) to ensure a single canonical field name.
 *
...
const PRESERVE_VALUE_FIELDS = new Set([
  ...
  'explanation', 'tags', 'difficulty', 'type', 'category',
  'subcategory', 'icon', 'color', 'colour_hex',
