...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const categories = await dbHelpers.find(
      "examCategories",
      {
        isActive: true,
      },
    ...
    res.json({
      success: true,
      ...paginateResponse(sortedCategories, limit, offset),
    });
  }),
);
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    res.json({
      success: true,
      ...paginateResponse(categoriesWithExams, limit, offset),
    });
  }),
);
...
router.put(
  ...
  asyncHandler(async (req, res) => {
    ...
    if (body.isActive !== undefined)
      examData.is_active = Boolean(body.isActive);
