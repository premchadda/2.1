...
router.get('/stats', responseCache('admin-payment-stats', 60), asyncHandler(async (req, res) => {
  await ensurePaymentsTable();
...
// POST /admin/payments/:id/refund — mark a payment as refunded
router.post('/:id/refund', superAdmin, asyncHandler(async (req, res) => {
  await ensurePaymentsTable();
