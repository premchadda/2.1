-- 079: Performance indexes for slow endpoints
...
CREATE INDEX IF NOT EXISTS idx_attempts_completed_submitted 
...
CREATE INDEX IF NOT EXISTS idx_tests_status_active 
...
CREATE INDEX IF NOT EXISTS idx_subject_videos_study_material 
  ON subject_videos(study_material_id) 
  WHERE is_active = true;

-- 7. Subject videos by chapter_id (used by hierarchical video queries)
CREATE INDEX IF NOT EXISTS idx_subject_videos_chapter 
...
CREATE INDEX IF NOT EXISTS idx_practice_answers_user_created 
