...
export const QuestionRow = ({
  ...
  const difficulty =
    DIFFICULTY_LEVELS.find((d) => d.value === question.difficulty) ||
    DIFFICULTY_LEVELS[1];
  const status =
    STATUS_OPTIONS.find((s) => s.value === question.status) ||
    STATUS_OPTIONS[1];
  const type =
  ...
  return (
    <div className="border-b border-gray-100 last:border-b-0">
      ...
      >
        <div className="hidden sm:block sm:col-span-1 text-sm text-gray-500 font-mono">
          {index + 1}
        </div>
