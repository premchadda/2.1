...
export { default as SubjectHierarchyManager } from "./study-materials/SubjectHierarchyManager";
export { default as SubjectHierarchyView } from "./study-materials/SubjectHierarchyManager";
...
export { default as PaymentsManager } from "./subscriptions-monetization/PaymentsManager";
...
export { default as UsersPermissions } from "./users-enrollments/UsersPermissions";
...
// Moderation
export { default as ModerationManager } from "./moderation/ModerationManager";

// Assessments extras
export { default as LiveProctoringConsole } from "./assessments-quizzes/LiveProctoringConsole";
...
export { default as ServerLogsManager } from "./system-settings/ServerLogsManager";
...
// NOTE: ComingSoonManager intentionally NOT re-exported — unrouted.
// Coming-soon config is settings-owned (AdminSettings → coming_soon_config);
// /admin/coming-soon is a canonical redirect to /admin/settings (see App.jsx).
export { default as ActiveSessionsManager } from "./system-settings/ActiveSessionsManager";
export { default as LiveTestMonitor } from "./system-settings/LiveTestMonitor";
export { default as TwoFactorManager } from "./system-settings/TwoFactorManager";
