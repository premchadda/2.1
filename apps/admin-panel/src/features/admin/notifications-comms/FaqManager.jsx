                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., How do I start a test?"
                    />
                  </div>
                  ...
                  <div className="flex gap-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <button
                      type="submit"
                      className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm font-semibold shadow-md shadow-indigo-500/20 transition"
                    >
