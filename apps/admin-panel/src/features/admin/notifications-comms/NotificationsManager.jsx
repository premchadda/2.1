...
const NOTIFICATION_TYPES = [
  { value: 'test_reminder', label: 'Test Reminder', icon: Clock, color: 'blue', textClass: 'text-blue-600', bgClass: 'bg-blue-100' },
  { value: 'result_declared', label: 'Result Declared', icon: CheckCircle, color: 'green', textClass: 'text-green-600', bgClass: 'bg-green-100' },
  { value: 'rank_achieved', label: 'Rank Achieved', icon: Trophy, color: 'purple', textClass: 'text-purple-600', bgClass: 'bg-purple-100' },
  { value: 'live_test_starting', label: 'Live Test Starting', icon: Clock, color: 'red', textClass: 'text-red-600', bgClass: 'bg-red-100' },
  { value: 'test_scheduled', label: 'Test Scheduled', icon: Calendar, color: 'indigo', textClass: 'text-indigo-600', bgClass: 'bg-indigo-100' },
  { value: 'offer', label: 'Offer/Promotion', icon: Bell, color: 'orange', textClass: 'text-orange-600', bgClass: 'bg-orange-100' },
  { value: 'system', label: 'System', icon: AlertCircle, color: 'gray', textClass: 'text-gray-600 dark:text-gray-400', bgClass: 'bg-gray-100 dark:bg-gray-800' },
  { value: 'achievement', label: 'Achievement', icon: Trophy, color: 'yellow', textClass: 'text-yellow-600', bgClass: 'bg-yellow-100' },
  { value: 'streak', label: 'Streak', icon: Clock, color: 'pink', textClass: 'text-pink-600', bgClass: 'bg-pink-100' },
  { value: 'subscription', label: 'Subscription', icon: Bell, color: 'teal', textClass: 'text-teal-600', bgClass: 'bg-teal-100' }
]
...
const PRIORITY_LEVELS = [
  ...
  { value: 'low', label: 'Low', color: 'text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700' }
]
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Send and manage user notifications</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border p-4">
          <p className="text-sm text-gray-500 dark:text-gray-400">Created (Last 7 Days)</p>
          <p className="text-2xl font-bold text-green-600">
            {notifications.filter(n => n.createdAt && (Date.now() - new Date(n.createdAt).getTime()) <= 7 * 24 * 60 * 60 * 1000).length}
          </p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border p-4">
            ...
            <div key={notifId} className="border-b last:border-b-0">
              ...
              >
                <div className="flex items-start gap-4">
                  <div className={`p-2 rounded-lg ${typeConfig.bgClass || 'bg-gray-100 dark:bg-gray-800'}`}>
                    <TypeIcon className={`w-5 h-5 ${typeConfig.textClass || 'text-gray-600 dark:text-gray-400'}`} />
                  </div>
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-1">{notification.message}</p>
              ...
              {isExpanded && (
                <div className="px-4 pb-4 pl-16 bg-gray-50 dark:bg-gray-900">
                  ...
                  {notification.actionUrl && (
                    ...
                    >
                      {notification.actionText ?? notification.metadata?.actionText ?? 'View'} →
                    </a>
                  )}
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between mt-4">
          ...
          <div className="flex items-center gap-1">
            ...
            {totalPages > 5 && <span className="px-2 text-sm text-gray-400 dark:text-gray-500">…</span>}
    ...
    <div className="p-3 sm:p-4 md:p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={resetForm} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded" aria-label="Close">
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="flex gap-4 mb-6 p-1 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg transition ${
                    sendMode === 'single' ? 'bg-white dark:bg-gray-800 shadow text-indigo-600' : 'text-gray-600 dark:text-gray-400'
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg transition ${
                    sendMode === 'bulk' ? 'bg-white dark:bg-gray-800 shadow text-indigo-600' : 'text-gray-600 dark:text-gray-400'
                  }`}
                >
