...
export default function EmailTemplatesManager() {
        ...
        if (updatedItem) {
          setTemplates((prev) =>
            (Array.isArray(prev) ? prev : []).map((t) =>
              (t.id || t._id) === editingId ? updatedItem : t,
            ),
          );
        }
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      setTemplates((prev) =>
        (Array.isArray(prev) ? prev : []).filter((t) => (t.id || t._id) !== id),
      );
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Manage system transactional email templates
          </p>
        </div>
                ...
                >
                  {editingId === templateId ? (
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => setShowPreview(templateId)}
                  ...
                  {showPreview === templateId &&
                    ...
                    createPortal(
                      ...
                      >
                        ...
                        >
                          <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between bg-gray-50/75 dark:bg-gray-800/75">
                          ...
                          <div className="p-5 overflow-y-auto max-h-[calc(80vh-120px)]">
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-3 pb-2 border-b border-gray-100 dark:border-gray-700">
                              Subject:{" "}
                            ...
                            {template.variables?.length > 0 && (
                              <div className="mt-5 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600">
                                ...
                                <div className="flex flex-wrap gap-1.5">
                                  {template.variables.map((v) => (
                                    <code
                                      key={v}
                                      className="px-2 py-0.5 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-xs rounded-md font-mono"
                                    >
                                      {"{{"}
                                      {v}
                                      {"}}"}
