...
import ChapterPageModal from "./components/ChapterPageModal.jsx";
import CurriculumGeneralModal from "./components/CurriculumGeneralModal.jsx";
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
      ...
      <ChapterPageModal
        ...
        closeChapterView={closeChapterView}
        CHAPTER_CONTENT_TABS={CHAPTER_CONTENT_TABS}
        getLevelEmoji={getLevelEmoji}
        getEntityId={getEntityId}
        navigate={navigate}
        reorderChapterResource={reorderChapterResource}
        chapterActiveItems={chapterActiveItems}
        chapterActiveTabConfig={chapterActiveTabConfig}
        getChapterTabCount={getChapterTabCount}
