...
const TestSeriesManager = lazy(
  () => import("./features/admin/assessments-quizzes/TestSeriesManager"),
);
const TestsManager = lazy(
  () => import("./features/admin/assessments-quizzes/TestsManager"),
);
const QuestionsManager = lazy(
  () => import("./features/admin/assessments-quizzes/QuestionsManager"),
);
const QuizzesManager = lazy(
  () => import("./features/admin/assessments-quizzes/QuizzesManager"),
);
const SectionsManager = lazy(
  () => import("./features/admin/assessments-quizzes/SectionsManager"),
);
const PracticeQuestionsManager = lazy(
  () => import("./features/admin/assessments-quizzes/PracticeQuestionsManager"),
);
...
const CurrentAffairsManager = lazy(
  () => import("./features/admin/study-materials/CurrentAffairsManager"),
);
const CategoriesManager = lazy(
  () => import("./features/admin/exams-categories/CategoriesManager"),
);

const ExamCategoriesManager = lazy(
  () => import("./features/admin/exams-categories/ExamCategoriesManager"),
);
const ExamInfoManager = lazy(
  () => import("./features/admin/exams-categories/ExamInfoManager"),
);
const StagesManager = lazy(
  () => import("./features/admin/exams-categories/StagesManager"),
);
const TagConfigsManager = lazy(
  () => import("./features/admin/exams-categories/TagConfigsManager"),
);

const AdminAnalytics = lazy(
  () => import("./features/admin/analytics-insights/AdminAnalytics"),
);
const DeepAnalytics = lazy(
  () => import("./features/admin/analytics-insights/DeepAnalytics"),
);
const LeaderboardResultsUnified = lazy(
...
const UserActivityLog = lazy(
  () => import("./features/admin/users-enrollments/UserActivityLog"),
);

const AuditTrailManager = lazy(
  () => import("./features/admin/audit-compliance/AuditTrailManager"),
);
const ResultsManager = lazy(
  () => import("./features/admin/audit-compliance/ResultsManager"),
);

const NotificationsManager = lazy(
  () => import("./features/admin/notifications-comms/NotificationsManager"),
);
const BannerManager = lazy(
  () => import("./features/admin/notifications-comms/BannerManager"),
);
const FaqManager = lazy(
  () => import("./features/admin/notifications-comms/FaqManager"),
);
const EmailTemplatesManager = lazy(
  () => import("./features/admin/notifications-comms/EmailTemplatesManager"),
);

const SubscriptionPlansManager = lazy(
  () =>
    import("./features/admin/subscriptions-monetization/SubscriptionPlansManager"),
);
const CouponsManager = lazy(
  () => import("./features/admin/subscriptions-monetization/CouponsManager"),
);
const PromotionManager = lazy(
  () => import("./features/admin/subscriptions-monetization/PromotionManager"),
);
const PaymentsManager = lazy(
  () => import("./features/admin/subscriptions-monetization/PaymentsManager"),
);

const AdminSettings = lazy(
  () => import("./features/admin/system-settings/AdminSettings"),
);
...
const RecycleBin = lazy(
  () => import("./features/admin/system-settings/RecycleBin"),
);
const SystemHealthMonitor = lazy(
  () => import("./features/admin/system-settings/SystemHealthMonitor"),
);
const ServerLogsManager = lazy(
  () => import("./features/admin/system-settings/ServerLogsManager"),
);
const ActiveSessionsManager = lazy(
  () => import("./features/admin/system-settings/ActiveSessionsManager"),
);
...
const TwoFactorManager = lazy(
  () => import("./features/admin/system-settings/TwoFactorManager"),
);
      ...
      <Suspense fallback={<PageSkeleton />}>
        <Routes>
          ...
          >
            ...
            />
            <Route
              path="subject-relations"
              element={
                <Navigate
                  to="/admin/study-materials?tab=subject-relations"
                  replace
                />
              }
            />
            ...
            <Route
              ...
              element={<PracticeQuestionsManager />}
            />
            ...
            <Route
              ...
              element={<SubscriptionPlansManager />}
            />
