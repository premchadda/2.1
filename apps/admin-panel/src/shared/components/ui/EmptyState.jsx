/**
 * SC-03: Shared EmptyState component for consistent empty data displays.
 * Configurable illustration, title, description, and CTA button.
 */
...
export default function EmptyState({
  ...
  const illustrationElement = customIllustration || defaultIllustrations[illustration] || defaultIllustrations.empty
