      ...
      >
        <div className="flex items-center gap-2">
          {onView && (
            <button
              onClick={() => onView(item)}
              className="text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300 p-1 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
          ...
          {onEdit && (
            <button
              onClick={() => onEdit(item)}
              className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300 p-1 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
          ...
          {onToggleActive && (
            <button
              ...
              className={`p-1 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 ${item.isActive ? "text-green-600 dark:text-green-400" : "text-gray-400 dark:text-gray-500"}`}
            >
              {item.isActive ? (
                <Eye className="w-4 h-4" />
              ) : (
          ...
          {onDelete && (
            <button
              ...
              className="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300 p-1 rounded focus:outline-none focus:ring-2 focus:ring-red-500"
            >
...
const VirtualTable = forwardRef(
  (
    ...
    if (data.length === 0) {
      return (
        <div
          className={`bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-700 overflow-hidden ${className}`}
        >
