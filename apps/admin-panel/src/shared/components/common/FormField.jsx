...
export const FormInput = ({
  ...
  <div className={wrapperClassName}>
    ...
    {helpText && !error && <p className={helpClass}>{helpText}</p>}
  </div>
)
...
export const FormFileUpload = ({
  ...
  <div className={wrapperClassName}>
    ...
    <label className="flex flex-col items-center justify-center gap-2 w-full h-24 border-2 border-dashed border-gray-300 rounded-xl bg-gray-50 hover:bg-gray-100 cursor-pointer transition">
      <input
        type="file"
        accept={accept}
        className="hidden"
