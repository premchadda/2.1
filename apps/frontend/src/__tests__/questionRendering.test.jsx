...
describe("Question and Option HTML / Entity Decoding and Sanitization", () => {
  describe("decodeHtmlEntities", () => {
    it("decodes escaped HTML tag entities (&lt;p&gt; -> <p>)", () => {
      const input =
        "&lt;p&gt;In the following question, select the related word.&lt;/p&gt;";
  ...
  describe("cleanHtmlWrapper", () => {
    ...
    it("handles nested inline tags within single paragraph", () => {
      expect(cleanHtmlWrapper("<p><b>Option A:</b> 12 m/s</p>")).toBe(
        "<b>Option A:</b> 12 m/s",
      );
    });
  });
  ...
  describe("mapQuestionToFrontend", () => {
    it("normalizes a backend question with raw eqt/hqt spans into clean en/hi objects", () => {
      const backendQuestion = {
        id: "101",
        question:
          '<span class="eqt"><p>Select the related word.</p><p>Watt: Power :: Pascal: ?</p></span><span class="hqt" style="display:none"><p>&#2357;&#2366;&#2335;: &#2358;&#2325;&#2381;&#2340;&#2367;</p></span>',
        options: [
          '<span class="eqt">Energy</span><span class="hqt" style="display:none">&#2314;&#2352;&#2381;&#2332;&#2366;</span>',
      ...
      expect(mapped.text.en).toBe(
        "<p>Select the related word.</p><p>Watt: Power :: Pascal: ?</p>",
      );
    ...
    it("correctly maps 0-indexed integer correct_option for Option A (0), Option B (1), Option C (2), Option D (3)", () => {
      const qA = mapQuestionToFrontend({
        id: "1",
        question: "Q1",
        options: ["A", "B", "C", "D"],
        correct_option: 0,
      });
      const qB = mapQuestionToFrontend({
        id: "2",
        question: "Q2",
        options: ["A", "B", "C", "D"],
        correct_option: 1,
      });
      const qC = mapQuestionToFrontend({
        id: "3",
        question: "Q3",
        options: ["A", "B", "C", "D"],
        correct_option: 2,
      });
      const qD = mapQuestionToFrontend({
        id: "4",
        question: "Q4",
        options: ["A", "B", "C", "D"],
        correct_option: 3,
  ...
  describe("MathRenderer Component", () => {
    ...
    it("decodes escaped HTML entities properly (&lt;p&gt; -> paragraph instead of literal tag text)", async () => {
      const { container } = render(
        <MathRenderer text="&lt;p&gt;Clean Question Stem&lt;/p&gt;" />,
      );
      await waitFor(() => {
