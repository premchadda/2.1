...
/**
 * Standard section order dictionary for Indian test prep exams
 */
...
/**
 * Normalize and sort test questions with assigned sections
 */
export const normalizeTestQuestions = (rawQuestions, testData) => {
  ...
  const getSecOrder = (name) =>
    standardSectionOrderMap[(name || "").toLowerCase().trim()] ?? 99;
