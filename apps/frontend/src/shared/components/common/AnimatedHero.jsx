  ...
  const renderDecorativeElements = () => {
    ...
    if (config.decorative.includes("floating-shapes")) {
      elements.push(
        ...
        >
          <div
            className="absolute top-1/4 left-1/4 w-4 h-4 bg-white/20 rounded animate-float"
            style={{ animationDuration: "15s" }}
          />
          <div
            className="absolute top-1/3 right-1/4 w-6 h-6 bg-white/15 rounded-full animate-float"
            style={{ animationDuration: "18s", animationDelay: "2s" }}
          />
          <div
            className="absolute bottom-1/3 left-1/3 w-3 h-3 bg-white/25 rounded animate-float"
    ...
    if (
      config.decorative.includes("timer-pulse") &&
      !config.decorative.includes("arena-glow")
    ) {
      elements.push(
        <div
          key="timer-pulse"
    ...
    if (config.decorative.includes("book-stack")) {
      elements.push(
        <div
          key="book-stack"
          className="absolute bottom-4 right-6 flex flex-col-reverse gap-1 opacity-20 pointer-events-none"
        >
    ...
    if (config.decorative.includes("floating-cards")) {
      elements.push(
        ...
        >
          <div
            className="absolute top-1/4 right-1/4 w-12 h-16 bg-white/10 rounded-lg animate-float"
            style={{ animationDuration: "18s" }}
          />
          <div
            className="absolute bottom-1/4 left-1/4 w-10 h-14 bg-white/5 rounded-lg animate-float"
    ...
    if (
      config.decorative.includes("exam-icons") ||
      config.decorative.includes("category-badges")
    ) {
      elements.push(
        <div
          key="exam-icons"
        ...
        >
          <div
            className="absolute top-1/4 right-1/3 text-2xl animate-float"
            style={{ animationDuration: "15s" }}
          >
            📋
          </div>
          <div
            className="absolute bottom-1/3 right-1/4 text-xl animate-float"
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {title && (
          <h1
            className={`${compact ? "text-xl sm:text-2xl md:text-xl sm:text-2xl lg:text-3xl font-black text-white mb-1 tracking-tight" : "text-xl sm:text-2xl lg:text-3xl md:text-2xl sm:text-3xl lg:text-4xl lg:text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4"} animate-slide-up`}
            style={{
        ...
        {subtitle && (
          <p
            className={`${compact ? "text-white/90 text-xs sm:text-sm max-w-[95vw] sm:max-w-2xl leading-relaxed" : "text-white/80 text-lg md:text-xl max-w-[95vw] sm:max-w-2xl"} animate-slide-up`}
