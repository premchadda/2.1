    ...
    const fetchData = async () => {
      try {
        ...
        const [recRes, spacedRes] = await Promise.all([
          api
            .get("/api/node-engine/recommendations?limit=4")
            .catch(() => ({ data: { data: [] } })),
          api
        ...
        if (!cancelled && import.meta.env.DEV)
          console.warn("NodeEngine widget fetch error:", err);
      } finally {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-indigo-200/70">
              Personalized mastery & spaced repetition schedule
            </p>
          </div>
        </div>
        ...
        {activeTab === "recommendations" ? (
          recommendations.length > 0 ? (
              ...
              >
                <div className="space-y-1.5 flex-1 pr-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-mono text-indigo-200/80 flex items-center gap-1">
                      <Target
                ...
                <button
                  onClick={() =>
                    toast.success(`Starting AI practice for ${item.title}`)
                  }
            ...
            <div className="text-center py-8 text-indigo-200/60 text-sm">
              ...
              All core topics are on track! Complete practice tests to generate
            ...
            >
              <div className="space-y-1">
                ...
                <p className="text-xs text-purple-200/70">
                  Forgetting curve threshold passed (Last reviewed:{" "}
              ...
              <button
                onClick={() =>
                  toast.success(`Launching revision session for ${item.title}`)
                }
          ...
          <div className="text-center py-8 text-indigo-200/60 text-sm">
            ...
            No revision topics due right now. Next spaced repetition check
