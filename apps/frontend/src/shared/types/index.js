...
export function mapTestSeriesToFrontend(backendSeries) {
  return {
    ...
    difficulty: backendSeries.difficulty || 'Medium',
...
export function mapTestToFrontend(backendTest) {
  ...
  return {
    ...
    difficulty: backendTest.difficulty || 'Medium',
...
export function mapQuestionToFrontend(backendQuestion) {
  ...
  return {
    ...
    correct: backendQuestion.correctOption !== undefined ? backendQuestion.correctOption : (backendQuestion.correct_option !== undefined ? backendQuestion.correct_option : backendQuestion.correct),
...
export function mapTestSeriesToBackend(frontendSeries) {
  return {
    ...
    totalTests: frontendSeries.totalTests,
