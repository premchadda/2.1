          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-3 font-medium flex flex-wrap items-center gap-2">
              <span className="flex items-center gap-1 bg-gray-50 dark:bg-gray-900 px-2 py-0.5 rounded text-gray-600 dark:text-gray-300 font-semibold border border-gray-100 dark:border-gray-700">
                <BookOpen className="w-3 h-3 text-gray-400 dark:text-gray-500" /> {subject.chapters || 0} Ch
              </span>
              <span className="flex items-center gap-1 bg-gray-50 dark:bg-gray-900 px-2 py-0.5 rounded text-gray-600 dark:text-gray-300 font-semibold border border-gray-100 dark:border-gray-700">
                <FileText className="w-3 h-3 text-gray-400 dark:text-gray-500" /> {subject.topics || 0} Topics
              </span>
            </p>
            ...
            {progress !== null && (
              <div className="mb-3">
                <div className="flex justify-between text-[10px] font-bold mb-1">
                  <span className="text-gray-500 dark:text-gray-400 uppercase tracking-wider">Progress</span>
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="flex flex-col items-center p-2 bg-blue-50/40 dark:bg-blue-900/20 rounded-lg border border-blue-50">
                ...
                <p className="text-[8px] text-gray-500 dark:text-gray-400 font-bold uppercase">Videos</p>
              </div>
              <div className="flex flex-col items-center p-2 bg-green-50/40 dark:bg-green-900/20 rounded-lg border border-green-50">
                ...
                <p className="text-[8px] text-gray-500 dark:text-gray-400 font-bold uppercase">PDFs</p>
              </div>
              <div className="flex flex-col items-center p-2 bg-purple-50/40 dark:bg-purple-900/20 rounded-lg border border-purple-50">
                ...
                <p className="text-[8px] text-gray-500 dark:text-gray-400 font-bold uppercase">Tests</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 page-transition fade-in">
      <Helmet>
        ...
        <meta name="description" content="Access comprehensive study materials, notes, and resources for exam preparation on Trstprep." />
        <meta property="og:title" content="Study Materials | Trstprep" />
        <meta property="og:description" content="Access comprehensive study materials, notes, and resources for exam preparation." />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                ...
                {studyHistory.length > 0 ? (
                    ...
                    >
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div className="min-w-0">
                          <h3 className="font-bold text-gray-900 dark:text-white truncate group-hover:text-brand-start transition-colors">{item.title}</h3>
                          <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium">Last: {item.lastAccessed}</p>
                        </div>
                      </div>
                  ...
                  <div className="w-full bg-white dark:bg-gray-800 rounded-2xl border-2 border-dashed border-gray-100 dark:border-gray-700 p-8 flex flex-col md:flex-row items-center gap-6 group">
                    ...
                    <div className="md:ml-auto">
                      <Link to="/study" className="px-5 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-bold shadow-lg shadow-indigo-200 dark:shadow-none hover:translate-y-[-2px] transition-all inline-block">
                        Start Learning →
                      </Link>
                    </div>
                  </div>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  {standaloneSubjects.map((subject, idx) => (
                    <SubjectCard key={subject.id || subject._id || subject.slug || idx} subject={subject} idx={idx} />
                  ))}
                </div>
              </section>
            )}
                ...
                return (
                  <div key={groupName} className="mb-6">
                    ...
                    >
                      ...
                      <div className={`w-8 h-8 rounded-full bg-gray-50 dark:bg-gray-900 flex items-center justify-center transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`}>
              ...
              <section className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
                ...
                <div className="space-y-5">
                  {popularMaterials.length > 0 ? (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            ...
                            <span className="text-[10px] text-gray-500 dark:text-gray-400 flex items-center gap-1">
                              <TrendingUp className="w-3 h-3 text-emerald-500" /> {item.pdf || 0} PDFs
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="py-2 text-center">
                      <p className="text-xs text-gray-500 dark:text-gray-400 italic">Exploring trending topics...</p>
                    </div>
                  )}
                </div>
                ...
                <div className="mt-8 p-4 bg-indigo-50 dark:bg-indigo-900/30 rounded-2xl border border-indigo-100 dark:border-indigo-800/60">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs font-bold text-indigo-900 dark:text-indigo-200">Study Goal</span>
                  </div>
                  ...
                  <button className="mt-3 w-full py-2 bg-indigo-600 text-white text-[10px] font-bold rounded-lg hover:bg-indigo-700 transition-colors" disabled aria-disabled="true" title="Coming soon">
                    Set My Goal
                  </button>
                </div>
              </section>
              ...
              <div className="bg-gradient-to-br from-brand-start to-brand-end rounded-3xl p-6 text-white text-center relative overflow-hidden">
                 ...
                 <div className="relative z-10 text-center">
                   ...
                   <p className="text-xs text-purple-100 mb-4 px-2">Talk to our mentors for a personalized study plan.</p>
                    <button className="w-full py-3 bg-white dark:bg-gray-800 text-brand-start font-bold rounded-xl text-sm hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors shadow-lg" disabled aria-disabled="true" title="Coming soon">
                      Chat Now
                    </button>
                 </div>
              </div>
        ...
        <div className="mt-12 bg-white dark:bg-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700 shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">Expert Study Tips</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="space-y-2">
                ...
                <h4 className="font-bold text-gray-800 dark:text-gray-200">{tip.title}</h4>
