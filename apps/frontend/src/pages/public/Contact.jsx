            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{contactInfo.email || 'Not available'}</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{contactInfo.phone || 'Not available'}</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{contactInfo.address || 'Not available'}</p>
                </div>
              </div>
            </div>
          </div>
