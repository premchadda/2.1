  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta
          name="description"
          content="Frequently asked questions about Trstprep - test preparation, accounts, subscriptions, and more."
        />
        <meta property="og:title" content="FAQ | Trstprep" />
        <meta
          property="og:description"
          content="Frequently asked questions about Trstprep."
        />
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        {isLoading ? (
          ...
          <div className="text-center py-10">
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              FAQs haven't been published yet. Our admin team is still adding
            ...
            <p className="mt-6 text-sm text-gray-500">
              Admin: Add FAQs in{" "}
              <code className="bg-gray-100 px-2 py-1 rounded">/admin/faqs</code>
            </p>
          </div>
        ) : (
            ...
            {faqs.map((faq, idx) => (
              <div
                ...
                className={`bg-white rounded-2xl border transition-all duration-300 overflow-hidden ${
                  openIndex === idx
                    ? "border-brand-start shadow-xl shadow-brand-start/5"
                    : "border-gray-100 shadow-sm hover:border-brand-start/30"
                }`}
              >
                <button
        ...
        <div className="mt-20 p-8 rounded-3xl bg-indigo-600 text-center relative overflow-hidden text-white">
          ...
          <div className="relative z-10">
            ...
            <a
              href="/contact"
              className="inline-flex items-center gap-2 bg-white text-indigo-700 px-8 py-3.5 rounded-2xl font-black text-sm hover:bg-indigo-50 transition-all shadow-xl shadow-black/10"
            >
              Get in Touch
            </a>
          </div>
