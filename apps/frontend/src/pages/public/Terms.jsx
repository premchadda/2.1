      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 space-y-6">
          <section>
            ...
            <p className="text-gray-600">By accessing and using Trstprep, you accept and agree to be bound by the terms and provision of this agreement.</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">2. Use License</h2>
            <p className="text-gray-600">Permission is granted to temporarily use Trstprep for personal, non-commercial use only.</p>
          </section>
          <section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">4. Test Series & Subscriptions</h2>
            <p className="text-gray-600">All purchases are final. Subscriptions renew automatically unless cancelled 24 hours before the renewal date.</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">5. Intellectual Property</h2>
            <p className="text-gray-600">All content, questions, and materials on Trstprep are the property of Trstprep and are protected by copyright laws.</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">6. Limitation of Liability</h2>
            <p className="text-gray-600">Trstprep shall not be liable for any indirect, incidental, or consequential damages.</p>
          </section>
          <section>
