      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-2 mb-4">
          <div className="flex flex-row items-center gap-2">
            <div className="relative flex-1 min-w-0">
              ...
              <input
                aria-label="Search tests, study materials, videos"
                type="text"
              ...
              {searchQuery && (
                <button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 p-0.5 focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded"
                >
            ...
            <button
              ...
              className="px-3 py-1.5 text-xs bg-indigo-600 text-white rounded-md hover:bg-indigo-700 flex-shrink-0 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
              Search
            </button>
          </div>
        ...
        {!query && !loading && (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600">
              Find tests, study materials, and more
            </p>
          </div>
        )}
      </div>
