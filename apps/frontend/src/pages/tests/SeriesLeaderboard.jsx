...
export default function SeriesLeaderboard() {
  ...
  const userRank = user
    ? leaderboard.find(
        (entry) => entry.userId === user.id || entry.userId === user._id,
      )
    : null;
  ...
  const getRankIcon = (rank) => {
    ...
    return (
      <span className="text-lg font-bold text-gray-600 dark:text-gray-400 w-6 text-center">
        {rank}
      </span>
    );
  };
  ...
  const handleExport = () => {
    ...
    const header = ["Rank", "Name", "Tests", "Accuracy", "Score"]
      .map(quoteCell)
      .join(",");
  ...
  if ((loadingSeries || loadingLeaderboard) && leaderboard.length === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900">
        ...
        <p className="text-gray-600 dark:text-gray-400 font-bold font-outfit">
          Retrieving rankings...
        </p>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-inter">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <Breadcrumb
              items={[
                ...
                {
                  label: currentSeries?.title || "Series",
                  href: `/test-series/${id}`,
                },
                { label: "Leaderboard" },
              ]}
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-xl sm:text-2xl lg:text-3xl md:text-2xl sm:text-3xl lg:text-4xl font-black font-outfit tracking-tight">
                  Hall of Fame
                </h1>
              </div>
              <p className="text-indigo-100 font-medium ml-12">
                {seriesName} • {leaderboard.length} competitive participant
            ...
            <div className="flex items-center gap-2 bg-black/20 backdrop-blur-sm p-1.5 rounded-2xl border border-white/5 self-start md:self-center">
              ...
              >
                <RefreshCw
                  className={`w-4 h-4 ${isFetchingLeaderboard ? "animate-spin" : ""}`}
                />
              </button>
            </div>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {topThree.length > 0 && (
          <div className="mb-16">
            <div className="flex flex-col md:flex-row items-end justify-center gap-6 md:gap-4 sm:gap-6">
              {/* 2nd Place */}
              {topThree[1] && (
                <div className="order-2 md:order-1 flex flex-col items-center animate-in slide-in-from-left duration-700">
                  <div className="relative mb-4">
                    ...
                    <div className="absolute -bottom-2 -right-2 bg-slate-500 text-white w-8 h-8 rounded-full flex items-center justify-center border-4 border-white font-black text-sm">
                      2
                    </div>
                  </div>
              ...
              {topThree[0] && (
                <div className="order-1 md:order-2 flex flex-col items-center -mt-10 animate-in zoom-in duration-500">
                  <div className="relative mb-4">
                    ...
                    <div className="absolute -bottom-2 -right-2 bg-amber-500 text-white w-10 h-10 rounded-full flex items-center justify-center border-4 border-white font-black text-lg">
                      1
                    </div>
                  </div>
                  <div className="text-center">
                    <p className="font-black text-2xl text-gray-900 dark:text-white font-outfit uppercase tracking-tight">
                      {topThree[0].name}
                    </p>
                    <p className="text-2xl sm:text-3xl lg:text-4xl font-black text-amber-500 drop-shadow-sm">
                      {topThree[0].score}%
                    </p>
                  </div>
                </div>
              ...
              {topThree[2] && (
                <div className="order-3 flex flex-col items-center animate-in slide-in-from-right duration-700">
                  <div className="relative mb-4">
                    ...
                    <div className="absolute -bottom-2 -right-2 bg-amber-700 text-white w-8 h-8 rounded-full flex items-center justify-center border-4 border-white font-black text-sm">
                      3
                    </div>
                  </div>
                  <div className="text-center">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-[22px] p-6 lg:p-8">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h3 className="text-gray-500 font-bold uppercase tracking-widest text-[10px]">
                      Your standing
                    </h3>
                    <div className="flex items-baseline gap-2">
                      <span className="text-2xl sm:text-3xl lg:text-4xl font-black text-gray-900 dark:text-white font-outfit">
                        Rank #{userRank.rank}
                      </span>
                    ...
                    <p className="text-sm text-gray-500 font-medium mt-1">
                      Keep practicing to break into the Top 10!
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-10">
                  <div className="text-center">
                    ...
                    <p className="text-xl sm:text-2xl lg:text-3xl font-black text-indigo-600">
                      {userRank.score}%
                    </p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xl sm:text-2xl lg:text-3xl font-black text-gray-900 dark:text-white">
                      {userRank.testsCompleted}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="p-6 md:p-8 border-b border-gray-50 dark:border-gray-700 flex items-center justify-between bg-gray-50/50">
            <h2 className="text-xl font-black text-gray-900 dark:text-white font-outfit">
              Full Rankings
            </h2>
            <div className="flex items-center gap-2">
              <button
                onClick={handleExport}
                className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-gray-600 hover:bg-white rounded-xl transition-all border border-transparent hover:border-gray-200"
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-4 text-[10px] font-bold text-gray-400 uppercase tracking-tight">
                    <span className="flex items-center gap-1">
                      <Target className="w-3 h-4" /> {entry.testsCompleted}{" "}
                      sessions
                    </span>
                    <span className="flex items-center gap-1">
                      <TrendingUp className="w-3 h-4" /> {entry.accuracy}% acc
                    </span>
                  </div>
                </div>

                <div className="text-right">
                  <p className="text-2xl font-black text-gray-900 dark:text-white font-outfit">
                    {entry.score}%
                  </p>
          ...
          {leaderboard.length === 0 && !loadingLeaderboard && (
            <div className="p-4 sm:p-6 text-center">
              ...
              <h3 className="text-xl font-black text-gray-900 dark:text-white mb-2 font-outfit">
                Rankings pending
              </h3>
              <p className="text-gray-500 max-w-xs mx-auto font-medium">
                No one has attempted this series yet. Take the initiative and
                secure the Top Rank today!
              </p>
              <Link
                to={`/test-series/${id}`}
