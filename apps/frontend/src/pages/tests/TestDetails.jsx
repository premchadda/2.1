...
import TestDetailsSidebar from "./components/TestDetailsSidebar";
...
function TestDetails() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="mx-auto px-2 sm:px-4 lg:px-4 pb-6">
        <Breadcrumb
          items={[
            { label: "Home", to: "/" },
            {
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <TestDetailsSidebar
            ...
            totalPermanentTests={totalPermanentTests}
            liveTestsCount={liveTestsCount}
            permanentFreeTestsCount={permanentFreeTestsCount}
            series={series}
            permanentTests={permanentTests}
          />
        </div>
      </div>
    </div>
