        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
          ...
          <div className="hidden md:grid grid-cols-2 gap-3 lg:w-[400px] animate-slide-in-right">
            {[
              ...
              { icon: Radio, label: '8 Languages', color: 'bg-red-400' },
                  ...
                  >
                    ...
                    <div className="h-2 bg-gray-200 dark:bg-gray-600 rounded-full overflow-hidden">
                      <div className={`h-full rounded-full ${
                        progress >= 70 ? 'bg-gradient-to-r from-green-400 to-green-600' : 
                      ...
                      >
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <span className={`px-2 py-0.5 text-[10px] font-medium rounded ${
                            test.type === 'Free' || !test.isPro ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'
                          }`}>
