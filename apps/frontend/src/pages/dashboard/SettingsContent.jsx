...
function SettingsContent({ user, refreshUser, logout, proPass, isDarkMode, toggleDarkMode, navigate, settingsTab, setSettingsTab: _setSettingsTab }) {
  ...
  const handleDeactivate = async () => {
    ...
    try {
      ...
      toast.error(error?.response?.data?.message || 'Failed to deactivate account. Please try again.')
    }
  }
