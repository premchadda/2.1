    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-[95vw] sm:max-w-2xl mx-auto">
            Share Trstprep with your friends and earn exciting rewards. For
            every friend who joins using your referral code, you both get
            discounts!
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-2xl p-8 text-white mb-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            <div className="flex-1 bg-white/10 rounded-xl px-6 py-4">
              <p className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-wider">
                {referralCode}
              </p>
            </div>
            <button
        ...
        <div className="bg-white rounded-2xl p-8 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Your friend signs up using your referral code and gets instant
                discount
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                You earn cash rewards and your friend gets discount on their
                first purchase!
              </p>
            </div>
          </div>
                ...
                {rewards.map((tier, idx) => (
                  <tr key={idx} className="hover:bg-gray-50">
                    <td className="py-3 px-4 font-medium text-gray-900">
                      {tier.referrals}{" "}
                      {tier.referrals === 1 ? "Friend" : "Friends"}
                    </td>
