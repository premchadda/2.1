              ...
              return (
                <div
                  ...
                  className={`bg-white dark:bg-gray-800 p-4 md:p-6 rounded-2xl transition-all duration-200 border border-gray-100 dark:border-gray-700/60 group ${
                    targetUrl ? 'cursor-pointer hover:shadow-lg hover:border-brand-start/40 hover:-translate-y-0.5' : 'hover:shadow-md'
                  } ${
                    isUnread
                ...
                >
                  <div className="flex gap-4">
                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-2xs ${getIconColor(notification.type)}`}>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            <h3 className={`font-bold text-base md:text-lg truncate group-hover:text-brand-start transition-colors ${
                              isUnread
