...
function Profile({ initialTab = "personal" }) {
  ...
  const _toggleNavMode = (mode) => {
    setNavMode(mode);
    localStorage.setItem("trstprep_navMode", mode);
  ...
  }, [user, authLoading, authResolved, navigate]);
  ...
  const _handleLanguageChange = (lang) => {
    ...
    toast.success(
      `Language changed to ${lang === "en" ? "English" : lang === "hi" ? "Hindi" : "English"}`,
    );
  };
  ...
  const _handleDeactivateAccount = async () => {
    if (
      !confirm(
        "Deactivate your account? You can sign in again later to reactivate it.",
      )
    )
      return;
  ...
  const _handleDeleteAccount = async () => {
    if (
      !confirm(
        "Delete your account? This will start the account deletion flow and sign you out.",
      )
    )
      return;
    ...
    try {
      ...
      await logout();
      navigate("/login", {
        state: { from: "/", message: "Account deletion requested" },
      });
    } catch (error) {
    ...
    <>
            ...
            <div className="bg-slate-900/60 backdrop-blur-xl rounded-3xl p-5 border border-white/20 shadow-2xl">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0 pt-1">
                  ...
                  <p className="text-sm text-white/70 font-medium mb-3 truncate">
                    {user.email}
                  </p>
            ...
            <div className="mt-3 bg-slate-900/60 backdrop-blur-xl rounded-2xl p-3 border border-white/20 shadow-2xl">
              <div className="grid grid-cols-5 gap-1">
                {[
                  ...
                  <div
                    key={label}
                    className={`text-center p-1.5 ${bg} rounded-xl backdrop-blur-sm`}
                  >
                    ...
                    <div className="text-[6px] font-semibold text-white/60 uppercase tracking-wider mt-0.5">
                      {label}
                    </div>
                  </div>
                ))}
      ...
      <div className="max-w-5xl mx-auto px-4 pb-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 mb-4 p-1.5 overflow-hidden">
          <div
            className="flex gap-0.5 overflow-x-auto hide-scrollbar cursor-grab active:cursor-grabbing"
            onMouseDown={(e) => {
          ...
          >
            {activeTab === "settings" ? (
              ...
              <>
                ...
                <div className="w-px h-5 bg-gray-200 dark:bg-gray-700 mx-0.5 self-center"></div>
                <button
                  onClick={() => handleTabChange("settings", "security")}
                  className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold whitespace-nowrap transition-all ${
                    activeTab === "settings"
                      ? "bg-indigo-600 text-white shadow"
                      : "text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700"
                    ...
                    <div className="p-5">
                      <div className="grid md:grid-cols-2 gap-3">
                        {[
                          ...
                          {
                            label: "Date of Birth",
                            val: personalInfo.dateOfBirth || "Not set",
                            icon: Calendar,
                            color: "#AF52DE",
                          ...
                          ({ label, val, icon: Icon, color: _color, bg }) => (
                            <div
                              key={label}
                      ...
                      return (
                        ...
                        >
                          <button
                            onClick={() =>
                              setExpandedExam(
                                expandedExam === examId ? null : examId,
                              )
                            }
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0 text-left">
                              ...
                              <div className="text-[10px] text-gray-500 truncate">
                                {examSeries.length} series •{" "}
                                {exam.testsDone || 0}/{exam.totalTests || 0}{" "}
                                tests
                              </div>
                            </div>
                            <ChevronDown
                          ...
                          {expandedExam === examId && examSeries.length > 0 && (
                            <div className="px-3 pb-3 space-y-2">
                              {examSeries.map((series) => {
                                const seriesId =
                                  series.id || series._id || series.slug;
                                const seriesLoading =
                                  unenrollingId === seriesId;
                                return (
                                  <div
                                    key={seriesId}
            ...
            >
                    ...
                    <div className="bg-white/80 dark:bg-gray-800/80 rounded-xl p-4 border border-red-200 dark:border-red-800">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-600 dark:text-gray-400 mb-3">
                            Your Pro Pass has expired. Renew to unlock all
                            premium features.
                          </p>
                          <Link
                            to="/pass"
                    ...
                    <div className="bg-gradient-to-r from-purple-50 to-amber-50 dark:from-purple-900/10 dark:to-amber-900/10 rounded-xl p-4 border border-purple-200 dark:border-purple-800">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-600 dark:text-gray-400 mb-3">
                            Unlock unlimited tests, detailed solutions, PYP
                            bank, and premium study materials.
                          </p>
                          <Link
                            to="/pass"
                            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-lg font-semibold text-sm hover:shadow-lg transition"
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div className="divide-y divide-gray-100 dark:divide-gray-700">
                  <button
                    onClick={() =>
                      window.open("https://help.trstprep.com", "_blank")
                    }
