...
function TopPerformers({ user, userStats, topPerformersLoading, topPerformers }) {
  return (
          ...
          <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl p-3 mb-4 border border-indigo-100 dark:border-indigo-800">
            <div className="flex items-center gap-3">
              ...
              <div className="text-right">
                <p className="font-bold text-indigo-600 dark:text-indigo-400">{userStats.rank && userStats.rank !== '-' ? '#' + userStats.rank : '—'}</p>
