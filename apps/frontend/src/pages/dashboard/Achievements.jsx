...
export default function Achievements() {
  ...
  const getRarityColor = (category) => {
    switch (category) {
      case 'milestone': return 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300 border-gray-300'
      case 'streak': return 'bg-orange-100 text-orange-600 dark:bg-orange-900 dark:text-orange-300 border-orange-400'
      case 'performance': return 'bg-purple-100 text-purple-600 dark:bg-purple-900 dark:text-purple-300 border-purple-400'
      case 'subject': return 'bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-300 border-blue-400'
      case 'special': return 'bg-pink-100 text-pink-600 dark:bg-pink-900 dark:text-pink-300 border-pink-400'
      case 'improvement': return 'bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-300 border-green-400'
      case 'engagement': return 'bg-cyan-100 text-cyan-600 dark:bg-cyan-900 dark:text-cyan-300 border-cyan-400'
      default: return 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300 border-gray-300'
    }
  }
        ...
        {user && !loading && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl text-center">
              ...
              <p className="text-3xl font-bold text-gray-900 dark:text-white">{summary.earned}</p>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl text-center">
              ...
              <p className="text-3xl font-bold text-gray-900 dark:text-white">{summary.percentage}%</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Completion</p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl text-center">
              <Crown className="w-8 h-8 text-purple-500 mx-auto mb-2" />
              <p className="text-3xl font-bold text-gray-900 dark:text-white">{earnedBadges.length}</p>
        ...
        {!user && (
          <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-xl mb-12">
            ...
            <div className="flex gap-4 justify-center">
              <Link to="/login" className="px-6 py-2 bg-brand-start text-white rounded-lg hover:opacity-90 transition">
                Sign In
              </Link>
              <Link to="/signup" className="px-6 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition">
                Sign Up
              </Link>
            </div>
          </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                  {earnedBadges.map(badge => (
                    ...
                    >
                      ...
                      <h3 className="font-semibold text-gray-900 dark:text-white text-sm">{badge.title}</h3>
              ...
              <div className="mb-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                  {lockedBadges.map(badge => (
                    ...
                    >
                      <div className="text-4xl mb-2 opacity-50 grayscale">{badge.icon}</div>
                      <h3 className="font-semibold text-gray-600 dark:text-gray-400 text-sm">{badge.title}</h3>
            ...
            {summary.recentAchievements && summary.recentAchievements.length > 0 && (
              <div className="mb-12">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {summary.recentAchievements.slice(0, 3).map((achievement, index) => (
                    <div key={index} className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md">
                      ...
                      <div className="p-6">
                        <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">{achievement.description}</p>
